...
//helper funkcija za handlebars  ->mora se registrovati u app.js gde je server
module.exports = {

    //helper funkcija za select opciju -vraca sve opcije , koje kroz funkcije fn dinamicno menja, gde uzima select opciju koja je poslednji put cekirana
    select: function(selected, options){
        return options.fn(this).replace(new RegExp(' value=\"'+ selected + '\"'), '$&selected="selected"');
    },


    //funkcija koja vraca formatiran datum uz pomoc moment modula
